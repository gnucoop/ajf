load("//:packages.bzl", "ANGULAR_PACKAGE_BUNDLES", "THIRD_PARTY_GEN_PACKAGE_BUNDLES", "THIRD_PARTY_NO_NGCC_PACKAGE_BUNDLES", "THIRD_PARTY_PACKAGE_BUNDLES")
...
def create_system_config(
    ...
    expand_template(
        ...
        substitutions = {
            ...
            "$BASE_URL": base_url,
            "$CALENDARS_ENTRYPOINTS_TMPL": str(CALENDARS_ENTRYPOINTS + CALENDARS_TESTING_ENTRYPOINTS),
            ...
            "$THIRD_PARTY_GEN_PACKAGE_BUNDLES": str(THIRD_PARTY_GEN_PACKAGE_BUNDLES),
