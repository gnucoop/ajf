 ...
 *
 * ```ts
 *   // Some file in @ajf/core/auth
 *   export {Model} from './model';
 *
 *   // Other file in @ajf/core/model
 *   export {Model} from '@ajf/core/model';
 *
 *   // Re-export of the same export with a different name (alias).
 *   export {Model as XModel} from './model';
 * ```
 *
 * This issue occurs sometimes in the Ajf repository, because some imports are
