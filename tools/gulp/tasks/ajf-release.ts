...
import {buildConfig, composeRelease, sequenceTask} from 'ajf-build-tools';
...
// Path to the release output of ajf.
const releasePath = join(releasesDir, 'ajf');
 ...
 */
task('ajf:build-release', ['ajf:prepare-release'], () => {
