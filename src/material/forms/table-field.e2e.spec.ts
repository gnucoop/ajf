...
describe('ajf-table-field', () => {
  ...
  it('should go to next cell when pressed the tab key in input', async () => {
    ...
    await cells[5].click();
    await browser.wait(
      ExpectedConditions.presenceOf(element(by.css('tr:nth-of-type(2) td:nth-of-type(2) input'))),
    );
    ...
    await browser.wait(
      ExpectedConditions.presenceOf(element(by.css('tr:nth-of-type(2) td:nth-of-type(3) input'))),
    );
  });
