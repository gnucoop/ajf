...
export const formSchema: any = {
  attachmentsOrigins: [],
  stringIdentifier: [{value: ['sex'], label: 'Gender'}],
  choicesOrigins: [
    {
      type: 'fixed',
      name: 'SEX',
    ...
    {
      name: 'DISTRICT_NAMES',
      label: 'DISTRICT_NAMES',
      type: 'fixed',
      choices: [
        {value: 'quelimane', label: 'Quelimane'}, {value: 'nicoadala', label: 'Nicoadala'},
        {value: 'namacurra', label: 'Namacurra'}
      ]
    },
    {
      name: 'QUELIMANE_COMMUNITY',
      label: 'QUELIMANE_COMMUNITY',
      type: 'fixed',
      choices: [
        {value: 'eduba', label: 'Eduba'}, {value: 'mazuere', label: 'Mazuere'},
        {value: 'navilembo', label: 'Navilembo'}, {value: 'mucor', label: 'Mucor'},
        {value: 'nangoela', label: 'Nangoela'}, {value: 'sareva', label: 'Sareva'}

      ]
    },
    {
      name: 'NICOADALA_COMMUNITY',
      label: 'NICOADALA_COMMUNITY',
      type: 'fixed',
      choices: [
        {value: 'curungu', label: 'Curungu'}, {value: '25 de jnho', label: '25 de jnho'},
        {value: 'supinho', label: 'Supinho'}, {value: 'maningue', label: 'Maningue'},
        {value: 'mariebe', label: 'Mariebe'}, {value: 'mucelo-Novo', label: 'Mucelo-Novo'}
      ]
    },
    {
      name: 'NAMACURRA_COMMUNITY',
      label: 'NAMACURRA_COMMUNITY',
      type: 'fixed',
      choices: [
        {value: 'cocodane', label: 'Cocodane'}, {value: 'mutange', label: 'Mutange'},
        {value: 'muebele', label: 'Muebele'}, {value: 'pida', label: 'Pida'},
        {value: 'mixixine', label: 'Mixixine'}, {value: 'furquia', label: 'Furquia'}
      ]
    },
    {
      type: 'fixed',
      ...
      choices: [
        ...
        {label: 'Fisherman', value: 'fisherman'}, {label: 'Other(specificy)', value: 'other'}
      ]
    },
    {
      type: 'fixed',
      label: 'PARTITION_500_FROM_0_OVER_2500',
      ...
      choices: [
        ...
        {label: '2001-2500', value: '2001-2500'}, {label: '>2500', value: '>2500'}
      ]
    },
    {
      type: 'fixed',
      label: 'PARTITION_200_FROM_0_TO_2500',
      ...
      choices: [
        ...
        {label: '1501-2000', value: '1501-2000'}, {label: '2001-2500', value: '2001-2500'}
      ]
    },
    {
      type: 'fixed',
      label: 'PARTITION_200_FROM_0_OVER_10000',
    ...
    {
      type: 'fixed',
      label: 'PARTITION_50_FROM_0_TO_300',
    ...
    },
    {
      ...
      label: 'PARTITION_3_FROM_1_TO_12',
      type: 'fixed',
      choices: [
        {label: 'from 1 to 3', value: 'from_1_to_3'}, {label: 'from 4 to 6', value: 'from_4_to_6'},
    ...
    {
      type: 'fixed',
      label: 'FERTILIZER_PURCHASED_OR_SELF_PRODUCED',
    ...
    },
    {
      ...
      label: 'PESTICIDIES_PURCHASED_OR_SELF_PRODUCED',
      choices: [
        {label: 'Purchased', value: 'purchased'},
    ...
    {
      name: 'ORGANIC_OR_NOT',
      label: 'ORGANIC_OR_NOT',
      type: 'fixed',
      choices: [{value: 'organic', label: 'Organic'}, {value: 'non-organic', label: 'Non-organic'}]
    },
    {
      name: 'METHOD_OF_CONTROL',
      label: 'METHOD_OF_CONTROL',
      type: 'fixed',
      choices: [
        {value: 'cultural', label: 'Cultural'}, {value: 'biological', label: 'Biological'},
        {value: 'mechanical', label: 'Mechanical'}, {value: 'integrated', label: 'Integrated'},
        {value: 'other', label: 'Other'}
      ]
    },
    {
      name: 'PRODUCTION_SHARE',
      label: 'PRODUCTION_SHARE',
      type: 'fixed',
      choices: [
        {value: 'good_growth', label: 'Good growth'}, {value: 'low_growth', label: 'Low growth'},
        {value: 'medium_growth', label: 'Medium growth'},
        {value: 'attack_of_curses', label: 'Attack of curses'},
        {value: 'excessive_heatstroke', label: 'Excessive heatstroke'},
        {value: 'flood', label: 'Flood'},
        {value: 'uncontrolled_burning', label: 'Uncontrolled burning'}
      ]
    },
    {
      name: 'PRODUCTION_PERCENTAGE',
      label: 'PRODUCTION_PERCENTAGE',
      type: 'fixed',
      choices: [
    ...
    },
    {
      ...
      label: 'MANAGES_TRANSPORT',
      type: 'fixed',
      choices: [
        {value: 'beneficiary_household_level', label: 'Beneficiary (household level)'},
        {value: 'community_member', label: 'Community member'},
        {value: 'external_operator', label: 'External operator'}
      ]
    },
    {
      name: 'VALUE_CHAIN',
      ...
      type: 'fixed',
      choices: [
        {value: 'weak', label: 'Weak'}, {value: 'intermediate', label: 'Intermediate'},
        {value: 'strong', label: 'Strong'}
      ]
    },
    {
      name: 'MARKETING_PRODUCTS_OSTACLES',
      label: 'MARKETING_PRODUCTS_OSTACLES',
      type: 'fixed',
      choices: [
        {value: 'storage', label: 'Storage'},
        {value: 'transport_to_markets', label: 'Transport to markets'}, {
          value: 'lack_of_information_on_market_prices',
          label: 'Lack of information on market prices'
        },
        {value: 'bargaining_with_intermediaries', label: 'Bargaining with intermediaries'}, {
          value: 'lack_of_direct_contacts_with_retailers',
          label: 'Lack of direct contacts with retailers'
        },
        {value: 'access_to_credit', label: 'Access to Credit'}
      ]
    },
    {
      name: 'AGRICULTURAL_PRACTICES',
      label: 'AGRICULTURAL_PRACTICES',
      type: 'fixed',
      choices: [
        {
    ...
    },
    {
      ...
      label: 'APPLICATION_VALUE',
      type: 'fixed',
      choices: [
        {label: 'Domestic utensils', value: 'domestic_utensils'}, {label: 'Seeds', value: 'seeds'},
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          parent: 201,
          fieldType: 4,
          label: 'Total monthly income (Meticais) - ' +
        ...
        },
        {
          ...
          parent: 203,
          fieldType: 4,
          label: 'Total monthly expenditures (Meticais) food, ' +
              'clothing, housing (rent), energy, transport, durable ' +
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          parent: 303,
          fieldType: 7,
          HTML: '<h1>How many times per day do you consume the ' +
              'following foods in this period?</h1>',
          name: '_3_304',
          nodeType: 0
        },
        {id: 305, parent: 304, fieldType: 7, HTML: '<h2>Protein:</h2>', nodeType: 0},
        {
          id: 306,
          parent: 305,
          fieldType: 2,
        ...
        {id: 308, parent: 307, fieldType: 7, HTML: '<h2>Vitamins:</h2>', nodeType: 0},
        {
          id: 309,
          parent: 308,
          fieldType: 2,
        ...
        {id: 311, parent: 310, fieldType: 7, HTML: '<h2>Carbohydrates:</h2>', nodeType: 0},
        {
          id: 312,
          parent: 311,
          fieldType: 2,
        ...
        },
        {
          ...
          parentNode: 0,
          nodeType: 0,
          visibility: {condition: 'diversity_periodically_name'},
          validation: {
            notEmpty: true,
            'maxValue': 6,
            'conditions': [
        ...
        },
        {
          ...
          parent: 318,
          fieldType: 7,
          HTML: '<h1>How many of the following foods have you consumed ' +
              'in the last 24hours?</h1>',
          name: '_3_319',
          nodeType: 0
        },
        {id: 320, parent: 319, fieldType: 7, HTML: '<h2>Protein:</h2>', nodeType: 0},
        {
          id: 321,
          parent: 320,
          fieldType: 2,
        ...
        {id: 323, parent: 322, fieldType: 7, HTML: '<h2>Vitamins:</h2>', nodeType: 0},
        {
          id: 324,
          parent: 323,
          fieldType: 2,
        ...
        {id: 326, parent: 325, fieldType: 7, HTML: '<h2>Carbohydrates:</h2>', nodeType: 0},
        {
          id: 327,
          parent: 326,
          fieldType: 2,
      ...
      nodes: [
        {
          ...
          parent: 4,
          fieldType: 4,
          label: 'Do you believe that your diet, and that your ' +
              'family members, are adequate for proper physical ' +
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          parentNode: 0,
          nodeType: 0,
          visibility: {condition: '_5_565 == \'yes\''},
          validation: {
            notEmpty: true,
            'maxValue': 6,
            'conditions': [{
        ...
        },
        {
          ...
          nodeType: 0,
          name: '_5_570',
          label: 'In your daily activity, are you informed ' +
              'about weather conditions, market prices, events and ' +
              'fairs for sale and visibility?',
          choicesOriginRef: 'YES_NO',
          validation: {notEmpty: true}
        },
        {
        ...
        },
        {
          ...
          nodeType: 0,
          name: '_5_572',
          label: 'What do you think are the biggest obstacles to the ' +
              'productivity of your fields?(Max 3 choices)',
        ...
        },
        {
          ...
          name: '_5_573',
          label: 'Please, specify',
          visibility: {condition: 'valueInChoice(_5_573, \'other\')'},
          validation: {notEmpty: true}
        },
        {
          id: 574,
      ...
      nodes: [
        {
          ...
          parent: 6,
          fieldType: 7,
          HTML: '<h1>What is the percentage of agricultural ' +
              'production that is earmarked for sale on the total ' +
              'production?</h1>',
        ...
        },
        {
          ...
          parent: 647,
          fieldType: 2,
          label: 'How much do you earn monthly from the sale of ' +
        ...
        },
        {
          ...
          parent: 6004,
          fieldType: 4,
          label: 'Do you have any link with cooperatives or ' +
        ...
        },
        {
          ...
          parent: 6006,
          fieldType: 4,
          label: 'Are you planning to establish contacts with ' +
              'existing associations and cooperatives for  marketing purposes?',
          name: '_6_6007',
          choicesOriginRef: 'YES_NO',
          parentNode: 0,
          nodeType: 0,
        ...
        },
        {
          ...
          name: '_6_6008',
          visibility: {condition: '_6_6007 == \'yes\''},
          validation: {notEmpty: true},
          parentNode: 0,
          nodeType: 0
        },
