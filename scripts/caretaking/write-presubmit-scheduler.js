...
/** Path to the local ajf repo. By default based on the location of this script. */
 ...
 * location.
 */
const presubmitScript = `${process.env.MAT_PRESUBMIT_DIR}/ajf-presubmit.sh`;
...
const githubSearchOptions = {
  ...
  per_page: 100,
  q: 'repo:gnucoop/ajf is:open type:pr label:"pr: merge ready" -label:"pr: merge safe"',
};
