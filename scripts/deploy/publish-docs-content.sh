...
# Publish ajf docs assets to the ajf-docs-content repo
...
if [ -z ${AJF_BUILDS_TOKEN} ]; then
  echo "Error: No access token for GitHub could be found." \
       "Please set the environment variable 'AJF_BUILDS_TOKEN'."
  exit 1
fi
...
# Path to the release output of the @ajf/material-examples package.
...
# Copy the @ajf/material-examples package to the docs-content repository.
