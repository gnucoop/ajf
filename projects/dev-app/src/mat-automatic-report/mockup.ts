...
export const formSchema: any = {
  choicesOrigins: [
    ...
    },
    {
      ...
      choices: [
        ...
        {value: 'option20', label: 'Option20'},
        {value: 'option21', label: 'Option21'},
        {value: 'option22', label: 'Option22'},
        {value: 'option23', label: 'Option23'},
        {value: 'option24', label: 'Option24'},
        {value: 'option25', label: 'Option25'},
        {value: 'option26', label: 'Option26'},
        {value: 'option27', label: 'Option27'},
        {value: 'option28', label: 'Option28'},
        {value: 'option29', label: 'Option29'},
        {value: 'option30', label: 'Option30'},
        {value: 'option31', label: 'Option31'},
        {value: 'option32', label: 'Option32'},
        {value: 'option33', label: 'Option33'},
        {value: 'option34', label: 'Option34'},
        {value: 'option35', label: 'Option35'},
        {value: 'option36', label: 'Option36'},
        {value: 'option37', label: 'Option37'},
        {value: 'option38', label: 'Option38'},
        {value: 'option39', label: 'Option39'},
        {value: 'option40', label: 'Option40'},
      ],
    },
    {
      type: 'fixed',
  ...
  nodes: [
    ...
    },
    {
      ...
      id: 3,
      name: 'relevant',
      label: 'Hidden fields with Relevant',
      nodeType: 3,
      nodes: [
        {
          parent: 3,
