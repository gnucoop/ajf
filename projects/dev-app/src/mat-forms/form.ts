      ...
      nodes: [
        {
          ...
          nodeType: 0,
          fieldType: 2,
          description: '1 decimal - required',
          hint: 'Any floating point value is accepted, but a warning shows above 300.',
        ...
        },
        {
          ...
          nodeType: 0,
          fieldType: 7,
          HTML: 'Inserts an HTML note in the form. The field row supplies the label, so the note carries only its body.',
        },
        {
          parent: 1005,
          id: 1006,
          ...
          nodeType: 0,
          fieldType: 9,
          description: 'dd/mm/yyyy - typeable',
        },
        ...
        {parent: 1008, id: 1009, name: 'range', label: 'Range', nodeType: 0, fieldType: 17},
        {
          ...
          nodeType: 0,
          fieldType: 17,
          description: 'range with the rating appearance',
          appearance: 'rating',
          start: 1,
          end: 5,
          step: 1,
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          nodeType: 0,
          fieldType: 5,
          description: 'forceExpanded - checkbox buttons',
          forceExpanded: true,
        ...
        },
        {
          parent: 2002,
          id: 2003,
          name: 'multiplechoice_many',
          label: 'Multiple choice answer more than 6 options',
          nodeType: 0,
          fieldType: 5,
          description: '>= 6 options - multi select with chips',
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          nodeType: 0,
          fieldType: 6,
          description: 'computed from the price above',
